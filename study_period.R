...
ggplot(data=df, aes(x=Delta, y=Number_of_uplifts, shape=Channel)) + 
	...
	theme(plot.title=element_text(size = 25), text=element_text(size=30, face='bold'), axis.title=element_blank(), axis.text.x=element_text(size=25,angle=45,hjust=1, face='bold'), legend.position='top')  +
